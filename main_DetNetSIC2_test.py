...
from DetNetSIC2 import DetNetSIC2
...
params = {
    ...
    'batch_size': 500,
    'DetNetSIC2_ZF_initial': True,
    'DetNetSIC2_layer': 30,
    'DetNetSIC2_outuser': 2,
...
DetNetSIC2_nodes = DetNetSIC2(params).creat_graph(ZF_initial=params['DetNetSIC2_ZF_initial'])
...
sers = model_eval(sess, params, DetNetSIC2_nodes, gen_data, params['test_iterations'])
