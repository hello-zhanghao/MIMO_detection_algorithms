...
class DetNetSIC(object):
    def __init__(self, params):
        ...
        self.L1 = params['DetNetSIC_layer1']
        self.L2 = params['DetNetSIC_layer2']
        self.outuser = params['DetNetSIC_outuser']
    ...
    def creat_graph(self, ZF_initial=True):
        ...
        print("Total number of trainable variables in DetNetSIC1", self.get_n_vars())
        ...
        # 2 串行干扰消除
        xhat2 = self.SIC(X_EST, self.H, self.y)
        x_est2 = xhat2[-1]
        ...
        print("Total number of trainable variables in DetNetSIC", self.get_n_vars())
