...
class MMNetiid(object):
    ...
    def layer(self, xhatt, rt):
        # 线性
        theta = tf.compat.v1.Variable(1.)
        W_t = tf.matrix_transpose(self.H)
        zt = xhatt + theta*self.batch_matvec_mul(W_t, rt)
